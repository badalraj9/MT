...
class IngestionService:
    def __init__(self, num_slabs=128, slab_size=4096, shm_class=AlignedSharedMemory):
        self.allocator = SlabAllocator(num_slabs=num_slabs, slab_size=slab_size, shm_class=shm_class)
